...
stabl = Stabl(
    lasso,
    # bootstrap_func=group_bootstrap,
    n_bootstraps=300,
...
# print("Run CV on onset of labor dataset")
# multi_omic_stabl_cv(X_train, y_train, outer_splitter=outter_cv, inner_splitter=chosen_inner_cv, estimators=estimators, task_type=task_type, save_path="results ool multi omic cv all", outer_groups=ids, early_fusion=True)
