...
stabl_en = clone(stabl).set_params(
    ...
    n_bootstraps=1000,
    lambda_grid=[
        {"C": np.logspace(-2, 0, 10), "l1_ratio": [.5]},
        {"C": np.logspace(-2, 0, 10), "l1_ratio": [.7]},
        {"C": np.logspace(-2, 0, 10), "l1_ratio": [.9]},
    ],
    verbose=1
)
...
stabl_sgl = clone(stabl).set_params(
    ...
    lambda_grid=[
        {"alpha": np.logspace(-2, 0, 10), "l1_ratio": [.5]},
        {"alpha": np.logspace(-2, 0, 10), "l1_ratio": [.7]},
        {"alpha": np.logspace(-2, 0, 10), "l1_ratio": [.9]}
    ],
    verbose=1
)
